...
function SanPhamSua() {
    ...
    return (
        <div id="SanPhamSua" className="col-md-9 ml-sm-auto col-lg-12 px-md-4">
            ...
            <div className="container">
                <form id="frmaddsp" onSubmit={submitDuLieu}>
                    ...
                    <div className="row mb-3">
                        ...
                        <div className="col-md-4">
                            ...
                            <input
                                ...
                                className="form-control"
                                value={sp.slug}
                                onChange={e => setSp({ ...sp, slug: e.target.value })} />
                        </div>
                        <div className="col-md-4">
                    ...
                    <div className="mb-3">
                        <button className="btn btn-primary" type="submit">Sửa sản phẩm</button>
                    </div>
                </form>
            </div>
        </div>
